...
async def create_upload_files(files: List[UploadFile] = File(...)):
    ...
    content = head_html + """
    <marquee width="525" behavior="alternate"><h1 style="color:#2596be;font-family:Arial">Here's Our Predictions!</h1></marquee>
...
async def main():
    content = head_html + """
    <marquee width="525" behavior="alternate"><h1 style="color:#2596be;font-family:Arial">Hey!! Please Upload Picture of Dog/Dogs!</h1></marquee>
    <h3 style="font-family:Arial">We'll Try to Predict Which of These Categories They Are:</h3><br>
    """

    original_paths = ['Afghan_1.jpg', 'Boxer_1.jpg', 'Doberman_1.jpg', 
                      'GermanSheperd_1.jpg', 'GoldenRetriever_1.jpg', 'Labrador_1.jpg']

    full_original_paths = ['static/original/' + x for x in original_paths]

    display_names = ['Afghan', 'Boxer', 'Doberman', 'German Sheperd', 'Golden Retriever', 'Labrador']
